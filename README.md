...
| --- | --- |
| [Clone Stability](https://github.com/abcsFrederick/Clone_stability) | This site contains the programs used in the publication "HIV Infected CD4+ T Cell Clones Are More Stable than Uninfected Clones During Long-Term Antiretroviral Therapy". Shuang Guo, Brian Luke, Amy R. Henry, Samuel Darko, Leah D. Brandt, Ling Su, David Sun, Daria Wells, Kevin W. Joseph, Dimiter Demirov, Elias K. Halvas, Daniel C. Douek, Xiaolin Wu, John W. Mellors, Stephen H. Hughes. PLoS Pathogens, 2022. |
...
| [Pipeliner documentation](https://github.com/CCBR/pipeliner-docs)<sup>2</sup> | This repository is the main source of documentation for users and developers working with or contributing to Pipeliner. |
...
| [wgs-seek](https://github.com/CCBR/wgs-seek) 📦 | Whole Genome-Sequencing Pipeline. This is the home of the pipeline, wgs-seek. Its long-term goals: to accurately call germline and somatic variants, to infer CNVs, and to boldly annotate variants like no pipeline before! |
| [XAVIER](https://github.com/CCBR/XAVIER) 📦 | eXome Analysis and Variant explorER. This is the home of the pipeline, XAVIER. Its long-term goals: to accurately call germline and somatic variants, to infer CNVs, and to boldly annotate variants like no pipeline before! |

<sup>1</sup> Dependencies handled unknown.
