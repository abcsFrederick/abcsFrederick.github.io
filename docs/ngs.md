...
* [RENEE](https://github.com/CCBR/RENEE){:target="_blank"}&nbsp;&nbsp;&nbsp;&nbsp;![snakemake](images/snakemake-small.svg)
...
* [TRANQUIL](https://github.com/CCBR/TRANQUIL){:target="_blank"}&nbsp;&nbsp;&nbsp;&nbsp;![snakemake](images/snakemake-small.svg)
...
* [LOGAN](https://github.com/CCBR/LOGAN){:target="_blank"}&nbsp;&nbsp;&nbsp;&nbsp;![nextflow](images/nextflow-small.svg)
    - LOGAN is a comprehensive whole genome-sequencing pipeline following the Broad's set of best practices.
* [XAVIER](https://github.com/CCBR/XAVIER){:target="_blank"}&nbsp;&nbsp;&nbsp;&nbsp;![snakemake](images/snakemake-small.svg)
...
* [MOP2](https://github.com/NCI-RBL/Dockers/tree/main/workflows/MOP2){:target="_blank"}&nbsp;&nbsp;&nbsp;&nbsp;![nextflow](images/nextflow-small.svg)
...
* [DTEG](https://github.com/NCI-RBL/Dockers/tree/main/workflows/DTEG){:target="_blank"}&nbsp;&nbsp;&nbsp;&nbsp;![nextflow](images/nextflow-small.svg)
...
* [ISOMIR](https://github.com/NCI-RBL/Dockers/tree/main/workflows/isomiR){:target="_blank"}&nbsp;&nbsp;&nbsp;&nbsp;![nextflow](images/nextflow-small.svg)
