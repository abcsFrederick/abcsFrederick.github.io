...
* [RENEE](https://github.com/CCBR/RENEE){:target="_blank"} <img src="assets/snakemake.jpg" width="45" height="15" />
...
* [TRANQUIL](https://github.com/CCBR/TRANQUIL){:target="_blank"} <img src="assets/snakemake.jpg" width="45" height="15" />
...
* [LOGAN](https://github.com/CCBR/LOGAN){:target="_blank"} <img src="assets/nextflow.jpg" width="40" height="12" />
    - LOGAN is a comprehensive whole genome-sequencing pipeline following the Broad's set of best practices.
* [XAVIER](https://github.com/CCBR/XAVIER){:target="_blank"} <img src="assets/snakemake.jpg" width="45" height="15" />
...
* [MOP2](https://github.com/NCI-RBL/Dockers/tree/main/workflows/MOP2){:target="_blank"} <img src="assets/nextflow.jpg" width="40" height="12" />
...
* [DTEG](https://github.com/NCI-RBL/Dockers/tree/main/workflows/DTEG){:target="_blank"} <img src="assets/nextflow.jpg" width="40" height="12" />
...
* [ISOMIR](https://github.com/NCI-RBL/Dockers/tree/main/workflows/isomiR){:target="_blank"} <img src="assets/nextflow.jpg" width="40" height="12" />
