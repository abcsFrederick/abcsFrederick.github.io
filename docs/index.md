...
![nextflow](images/nextflow-small.svg) : indicates the repository is a Nextflow workflow.

![snakemake](images/snakemake-small.svg) : indicates the repository is a Snakemake workflow. 
